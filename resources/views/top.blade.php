	...
	<div class="col-5">
		<form method="POST" action="{{ route('login') }}">
			...
			<table>
				<tr>
					<th>ユーザ名</th>
					<td><input type="text" class="form-control" placeholder="例：すけまる" size="50" value="{{ old('email') }}" name="username" required autofocus></td>
				</tr>
				<tr>
					<th>メールアドレス</th>
					<td><input type="email" class="form-control" placeholder="example@example.com" size="50" name="email" required></td>
				</tr>
				<tr>
					<th>パスワード</th>
